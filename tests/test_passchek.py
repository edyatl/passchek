...
def test_convert_key_val_tpl():
    assert convert_key_val_tpl('08613D876336B480896C990CCC9451C66C5:12') == ('08613D876336B480896C990CCC9451C66C5', 12)
    assert convert_key_val_tpl("34ECD5DC2D7B0ECE7998AFB5C7AFC33A7AFD7:10") == ('34ECD5DC2D7B0ECE7998AFB5C7AFC33A7AFD7', 10)
...
def test_get_matches2(mock_print, mock_getpass, mock_reqst):
    ...
    mock_print.assert_called_once_with('This password has appeared 2 times in data breaches.')
    mock_reqst.assert_called_once()

    # Test case 2: Password has no matches in pwnedpassword DB
    mock_reqst.return_value = ''
    get_matches(True)
    mock_print.assert_called_with('This password has not appeared in any data breaches!')
